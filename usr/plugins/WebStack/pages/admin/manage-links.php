        ...
        <div class="row typecho-page-main manage-metas">
                <div class="col-mb-12">
                    <ul class="typecho-option-tabs clearfix">
                        <li class="current"><a href="<?php $options->adminUrl('extending.php?panel=WebStack%2Fpages%2Fadmin%2Fmanage-links.php'); ?>"><?php _e('友情链接'); ?></a></li>
                        <li><a href="https://bbs.geekscholar.net/d/35-webstack" title="查看友情链接使用帮助" target="_blank"><?php _e('帮助'); ?></a></li>
                    </ul>
                </div>
                        ...
                        <div class="operate">
                            ...
                            <div class="btn-group btn-drop">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a lang="<?php _e('你确认要删除这些链接吗?'); ?>" href="<?php $options->index('/action/webstack-action?do=delete'); ?>"><?php _e('删除'); ?></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-mb-12 col-tb-4" role="form">
                    <?php WebStack_Plugin::form()->render(); ?>
                </div>
        </div>
    </div>
</div>
    ...
    $(document).ready(function () {
        var table = $('.typecho-list-table').tableDnD({
            onDrop : function () {
                ...
                $.post('<?php $options->index('/action/webstack-action?do=sort'); ?>',
                    $.param({lid : ids}));
