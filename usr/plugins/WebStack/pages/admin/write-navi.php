...
include 'header.php';
include 'menu.php';
require_once 'WebStack/pages/widget/Widget_Contents_Post_Edit_Redefine.php';

//Typecho_Widget::widget('Widget_Contents_Post_Edit');

Typecho_Widget::widget('Widget_Contents_Post_Edit_Redefine')->to($post);
if (@$_POST['do'] == 'publish' || @$_POST['do'] == 'save'){

    Typecho_Widget::widget('Widget_Contents_Post_Edit_Redefine')->action();
}
?>
<style>
    table input{
    ...
    /*不显示其他自定义选项*/
    #custom-field tbody tr:nth-child(n+4){
        display: none;
    }
</style>
<div class="main">
    <div class="body container">
        ...
        <div class="row typecho-post-area" role="form">
<!--            <form action="--><?php //$security->index('/action/contents-post-edit'); ?><!--" method="post" name="write_post">-->
                ...
                <div class="col-mb-12 col-tb-9" role="main">
                    ...
                    <?php endif; ?>
                    <input name="type" type="hidden" value="navigation" />

                    <p class="title">
                        <label for="title" class="sr-only"><?php _e('链接名'); ?></label>
                    ...
                    <p style="height: 0;width: 0;position: fixed;top: -100px;">
...
<!--                            <button type="button" id="btn-preview" class="btn"><i class="i-exlink"></i> --><?php //_e('预览文章'); ?><!--</button>-->
                            ...
                            <button type="submit" name="do" value="publish" class="btn primary" id="btn-submit"><?php _e('发布导航'); ?></button>
