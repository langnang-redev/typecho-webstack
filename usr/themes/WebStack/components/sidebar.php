  ...
  <div class="sidebar-menu-inner">
    ...
    <ul id="main-menu" class="main-menu">
      ...
      <?php while ($categories->next()) :
        if ($hidecategries and in_array($categories->mid, $hidecategries)) {
          continue;
        }
      ?>
          ...
          <?php if (empty($children)) { ?>
            <li class="">
              <a href="<?php echo '#' . $categories->name; ?>">
                <i class="fa fa-solid fa-regular fa-brands <?php $categories->slug(); ?>"></i>
                ...
                <?php foreach ($children as $mid) { ?>
                  ...
                  <li>
                    <a href="<?php echo '#' . $child['name']; ?>">
                      <i class="fa fa-solid fa-regular fa-brands <?php echo $child['slug']; ?>"></i>
                      <?php echo $child['name']; ?>
                    </a>
                  </li>
                <?php } ?>
