...
<footer class="main-footer sticky footer-type-1">
  <div class="footer-inner">
    ...
    <div class="one_footer_mar">
      ...
      <a href="https://github.com/gogobody/WebStack" target="_blank"><strong> WebStack</strong></a>&nbsp; Design BY <a href="http://webstack.cc" target="_blank"><strong>Webstack</strong></a>&nbsp; Modify BY <a href="https://bbs.ijkxs.com/d/35-webstack" target="_blank"><strong>GOGOBODY</strong></a>
      &nbsp;&nbsp;版权所有:<b><?php $this->options->one_r(); ?></b>
      &nbsp;&nbsp;&nbsp;<a href="http://beian.miit.gov.cn/" target="_blank"><strong> <?php $this->options->one_icp(); ?> </strong></a>
    </div>
...
<?php $nowpage = null;
if ($this->is('index')) $nowpage = 'index';
else $nowpage = 'page';
...
<script src="<?php $this->options->themeUrl('assets/js/webstack.js'); ?>"></script>
<?php if ($this->options->usecdn) : ?>
  <!-- <script src="https://cdn.jsdelivr.net/gh/gogobody/WebStack/js/webstack.js"></script> -->
<?php else : ?>
<?php endif ?>
<script type="text/javascript">
  WebStackInit();
  <?php if ($this->options->one_ah == 1) : ?>webStack.nightModeInit() <?php endif; ?>
</script>
<!--统计代码-->
