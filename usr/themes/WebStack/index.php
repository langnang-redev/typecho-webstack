...
<div class="main-content">
    ...
    <?php if ($this->options->one_top_main == 1) : ?>
      <div class="one_top_main">
        <div class="col-lg-3 col-md-3 color-m">
          <a class="colorful-card one_top_one" target="_blank" href="<?php $this->options->one_top_main_one_url(); ?>">
            <i class="<?php $this->options->one_top_main_one_icon(); ?>"></i><?php $this->options->one_top_main_one_name(); ?>
          </a>
        </div>
        <div class="col-lg-3 col-md-3 color-m">
          <a class="colorful-card one_top_two" target="_blank" href="<?php $this->options->one_top_main_two_url(); ?>">
            <i class="<?php $this->options->one_top_main_two_icon(); ?>"></i><?php $this->options->one_top_main_two_name(); ?>
          </a>
        </div>
        <div class="col-lg-3 col-md-3 color-m">
          <a class="colorful-card one_top_three" target="_blank" href="<?php $this->options->one_top_main_three_url(); ?>">
            <i class="<?php $this->options->one_top_main_three_icon(); ?>"></i><?php $this->options->one_top_main_three_name(); ?>
          </a>
        </div>
        <div class="col-lg-3 col-md-3 color-m">
          <a class="colorful-card one_top_four" target="_blank" href="<?php $this->options->one_top_main_four_url(); ?>">
  ...
  <?php while ($categories->next()) :
    ...
    if ($hidecategries and (in_array($categories->mid, $hidecategries) or ($categories->parent and in_array($categories->parent, $hidecategries)))) {
      continue;
    }
  ?>
    <?php if (count($categories->children) === 0) : ?>
      ...
      <h3 class="text-gray" style="font-size: 24px;">
        <i class="fa fa-solid fa-regular fa-brands <?php $categories->slug(); ?>" id="<?php $categories->name(); ?>"></i>
        <?php $categories->name(); ?>
        <?php if ($this->user->hasLogin()) : ?>
          <a href="/admin/category.php?mid=<? echo $categories->mid; ?>" target="_blank" style="margin-left: 10px;">
      ...
      <div class="row">
        <?php while ($posts->next()) : ?>
          <div class="col-sm-3">
            <?php if ($this->user->hasLogin()) : ?>
              <a href="/admin/extending.php?panel=WebStack%2Fpages%2Fadmin%2Fwrite-navi.php&cid=<? echo $posts->cid; ?>" target="_blank" style="position: absolute;top: 11px;right: 15px;z-index: 99;font-size: 24px;">
